...
let chooseBurger = prompt('hamburger or cheeseburger?').replaceAll(` `,``).toLowerCase();
...
if (potato) {
    let chooseSize = prompt('Choose potato size: small/middle/big').replaceAll(` `,``).toLowerCase();
    if (chooseSize === `small`) {
        finalSize = smallSize;
...
if (sauce) {
    let chooseSauce = prompt('Choose sauce: ketchup/mayonnaise').replaceAll(` `,``).toLowerCase();
